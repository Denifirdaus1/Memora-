...
export const mockUploads: ThreadUpload[] = [
  {
    ...
    storage_path: "demo-user/kapitel-3/upload-1/kapitel3-page33.jpg",
    storage_deleted_at: "2026-05-12T10:20:00.000Z",
    error_message: null,
    extraction_summary: {
      vocabulary: 24,
      grammar_patterns: 4,
  ...
  },
  {
    ...
    status: "processing",
    storage_bucket: "temp-uploads",
    storage_path: "demo-user/a1-verbs/upload-2/modal-verbs.pdf",
